...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |449|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(define ε 0.001)
...
(define (find-root f left right)
  (local (; [Number -> Number] Number Number Number Number -> Number
          (define (helper f left right f@left f@right)
            (cond
              [(<= (- right left) ε) left]
              [else
