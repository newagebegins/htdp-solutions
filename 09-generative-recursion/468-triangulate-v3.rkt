...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 468-triangulate-v3) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (leading-zeroes? '((0 1 2 3) (0 3 4 5))) #true)
(check-expect (leading-zeroes? '((0 1 2 3) (1 3 4 5) (0 3 4 4))) #false)
