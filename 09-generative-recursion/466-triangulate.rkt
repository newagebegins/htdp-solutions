...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 466-triangulate) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
  ...
  (cond
    ...
    [else
     (local ((define e1 (first soe)))
       (cons e1 (triangulate (for/list ([i (rest soe)])
                               (subtract i e1)))))]))
