...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 314-blue-eyed-child-in-forest) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (blue-eyed-child-in-forest? a-forest)
  (for/or ([child a-forest])
    (blue-eyed-child? child)))
