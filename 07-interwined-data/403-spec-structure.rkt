...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 403-spec-structure) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
