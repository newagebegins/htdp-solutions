...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 405-row-filter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
