...
(check-expect (move-block (make-block 0 0)) (make-block 0 1))
(check-expect (move-block (make-block 3 (- MAX-Y 1))) (make-block 3 MAX-Y))
...
(define (tetris-update t)
  (if (block-landed? t)
      ...
      (make-tetris (move-block (tetris-block t))
                   (tetris-landscape t))))
