...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 114-v-animal) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(check-expect (animal? (make-v-cat 3 99)) #true)
