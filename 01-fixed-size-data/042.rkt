...
; interpretation: the number of pixels between the left border of the scene and the right-most edge of the car.
...
(define (render cw)
  (place-image CAR (- cw CAR-HALF-WIDTH) Y-CAR
