...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |093|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(check-expect (draw-cham (make-cham 55 100 "green"))
              (place-image CHAM 55 CTR-Y BACKGROUND))
(check-expect (draw-cham (make-cham 22 100 "red"))
              (place-image CHAM 22 CTR-Y BACKGROUND))

(define (draw-cham c)
  (place-image CHAM (cham-x c) CTR-Y BACKGROUND))
