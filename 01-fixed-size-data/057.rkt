...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |057|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(check-expect (render-rocket 53) (place-image ROCKET 10 (- HEIGHT 53 CENTER) BACKG))
